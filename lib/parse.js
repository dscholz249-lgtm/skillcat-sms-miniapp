...
3. log_note — ANY message that mentions a person's name and is not an assign_training or add_employee intent. Use this broadly: a manager texting anything about a named technician is a note. Set employee_name to the person's name. Set note_body to the full message text verbatim. confidence = "high" if the name is unambiguous, "low" only if the name is genuinely unclear.

4. unclear — no person's name is present AND no clear action can be determined. Use sparingly.
...
- assign_training and add_employee: tags = []`;

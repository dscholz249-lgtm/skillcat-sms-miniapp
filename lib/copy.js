...
const COPY = {
  ...
  BATCH_MULTI: (n, names) =>
    `SkillCat: You've got ${n} reviews to do today — ${joinNames(names)}. Who do you want to start with?`,
  ...
  NO_SESSION:
    `No open reviews right now. You'll get a text when there's a review to do.`,
  ...
  AMBIGUOUS_NAME: (a, b) =>
    `Did you mean ${a} or ${b}?`,
  HELP:
    `SkillCat reviews. Reply a technician's name and whether they're ready (yes/no). Msg & data rates may apply. Reply STOP to opt out.`,
};
